...
DEFAULT_CORE_CONTAINMENT_THRESHOLD = 0.70
DEFAULT_LOCAL_RADIUS_KM = 20.0
DEFAULT_CORE_IMPROVEMENT_EPSILON = 0.0025
DEFAULT_SATELLITE_FLOW_THRESHOLD = 0.02
DEFAULT_MAX_SATELLITES = 4
DEFAULT_MOBILITY_PRUNE_MIN_SEED_CAPTURE = 0.80
