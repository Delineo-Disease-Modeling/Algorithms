# VENDORED from Simulation/simulator/patterns_codec.py — keep byte-compatible.
# Algorithms uses the ENCODE side (build_arrays_from_legacy + encode_patterns_binary);
# the Simulation consumer decodes the same format. Any change to the wire layout
# MUST be made to both copies in lockstep.
...
def build_arrays_from_legacy(patterns: dict, papdata: dict):
    ...
    Algorithms producer; the consumer never calls this.
    """
